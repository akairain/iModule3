<div class="mentBlock" style="margin-left:<?php echo $ment->depth * 3; ?>%;">
	...
	<div class="mentHeader">
		...
		<div class="button">
			<div>
				<button type="button" class="reply" onclick="Lms.ment.reply(<?php echo $ment->idx; ?>,this);" data-cancel="<i class='fa fa-times'></i> <?php echo $Module->getLanguage('button/reply_cancel'); ?>"><i class="fa fa-reply"></i> <?php echo $Module->getLanguage('button/reply'); ?></button>
				<button type="button" class="modify" onclick="Lms.ment.modify(<?php echo $ment->idx; ?>,this);" data-cancel="<i class='fa fa-times'></i> <?php echo $Module->getLanguage('button/modify_cancel'); ?>"><i class="fa fa-pencil"></i> <?php echo $Module->getLanguage('button/modify'); ?></button>
				<button type="button" class="delete" onclick="Lms.ment.delete(<?php echo $ment->idx; ?>,this);"><i class="fa fa-times"></i></button>
			</div>
			<div class="ip">
				<?php echo $ment->ip; ?>
			</div>
